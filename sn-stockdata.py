...
# -----------------------------------------------------------------------------
# Code for Japansese Candlestick (needed to do '$ pip install mpl_finance')
# -----------------------------------------------------------------------------
...
# Since GOOG more expensive; AAPL, MSFT seem less volatile
# Use secondary sclae for AAPL, MSFT to get better picture
